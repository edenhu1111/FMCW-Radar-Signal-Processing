...
#Target Point
Rb = 3                                 #The coordinate of the point target is (5,50)
...
def main():
    # print('K='+str(K))
    # print('V='+str(velocityOfSAR))
    # print('fam='+str(2*velocityOfSAR*fc/c))
    # print('PRF_res='+str(PRF/slowTimeDotsNum))
    # print('f_res = '+str(Fs/fastTimeDotsNum))
